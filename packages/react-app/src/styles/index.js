const styles = {
  ...
  header: "flex flex-row justify-between items-center w-full sm:pt-10 py-6 border border-dotted",
  ...
  exchangeBox: "relative lg:max-w-[500px] xl:max-w-[700px] min-w-[400px] gradient-border p-[2px] rounded-3xl",
  exchange:
